...
<script>
  ...
  export default {
      ...
      methods: {
        search () {
          axios.get('http://127.0.0.1:8080/admin/post/'+this.searchPost)
            .then((res) => {
        ...
        modifyPost () {
          ...
          axios.post('http://127.0.0.1:8080/admin/modify/post/'+this.postId,post)
            .then( () => {
            alert('수정완료')
          })
        },
        ...
        deletePost () {
          ...
          if(this.postId != ''){
            alert('삭제요청')
            axios.delete('http://127.0.0.1:8080/admin/delete/post/'+this.postId)
              .then( () => {
                alert('삭제완료')
              })
          }else {
